...
- Design doc **v1.14**, visual direction **v1.5**, roadmap **v1.7**, team charter **v1.13**, mockups **v2.2** (deck plan) / flow overlay companion.
- Shipped: `p1-project-scaffold` (P1 #1), `p1-deck-geometry` (P1 #2), `p1-player-controller` (P1 #3), `p1-combat-core` (P1 #4, incl. combat-readability hotfix). In pipeline: `p1-enemy-baseline` (P1 #5) — Stage 1 design pack v1 delivered; Stage 2 spec pending Grok. Next: `p1-mission-shell` (P1 #6) — **hold until Director kickoff.**
