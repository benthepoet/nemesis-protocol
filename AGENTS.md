...
- Shipped: `p1-project-scaffold` (P1 #1), `p1-deck-geometry` (P1 #2), `p1-player-controller` (P1 #3), `p1-combat-core` (P1 #4, incl. combat-readability hotfix), `p1-enemy-baseline` (P1 #5). Next: `p1-mission-shell` (P1 #6) — **hold until Director kickoff.**
