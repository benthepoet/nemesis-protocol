...
| 2026-07-30 | Gate 2 (Director) | **accept** — release to `master`; Gate 2 iterations: stick Y→Z sign (`0ca0114`), mouse aim on cursor move only (`dcc4aa5`) |
| | Director iterations (§3.5a) | cycle 1: gamepad axis sign (impl); cycle 2: KBM aim sticky vs pad (impl) |
| | Escalations | none |
