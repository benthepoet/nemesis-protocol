...
**Status:** v1.7 — P1 #1–#4 shipped (Gate 2 through 2026-07-30); phase visual-pass policy (Director ruling R1, 2026-07-30): one terminal visual-pass feature per phase; P1 #9 appended; P2–P4 visual-pass rows scoped
